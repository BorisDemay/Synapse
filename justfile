...
verify: fmt-check clippy test-rust test-native-rust test-js test-harness test-release test-security test-operations typecheck lint audit-rust audit-js e2e-recovery test-recovery test-release-drill
...
test-recovery: test-recovery-selfhosted test-recovery-backup

test-recovery-selfhosted:
    bash tests/integration/self_hosted.sh

test-recovery-backup:
    bash tests/integration/backup_restore.sh

# Isolated real-Docker drill of infra/scripts/deploy-release.sh: migration
# backup, manifest-last activation and image/pointer rollback.
test-release-drill:
    bash tests/integration/release_drill.sh

e2e-recovery:
    pnpm exec playwright test tests/e2e/web-register-save.spec.ts tests/e2e/web-offline.spec.ts tests/e2e/reliability.spec.ts tests/e2e/conflict-resolution.spec.ts tests/e2e/full-sync.spec.ts tests/e2e/offline-update.spec.ts tests/e2e/update-ready.spec.ts tests/e2e/deleted-items.spec.ts tests/e2e/sequential-autosave.spec.ts
