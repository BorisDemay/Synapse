...
| Design system             | PrimeVue 4 in **unstyled** mode, in-house Vue components and `--synapse-*` CSS tokens                                 | MIT; presentation owned in-repo, no theme preset, no proprietary UI kit   |
