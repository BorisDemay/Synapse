...
- `pnpm test`: 660 tests passed (API client 2, UI 238, web 307, desktop 113),
  after integrating the concurrent upstream registration, editor-shortcut and
  assistant-stream fixes.
